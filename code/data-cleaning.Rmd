...
Por otro lado, podemos realizar otro análisis comparativo respecto al género, con el objetivo de explorar si hay diferencias significativas en las características clínicas entre hombres y mujeres, descubriendo qué características cardíacas influyen más en la salud de cada género, como la frecuencia cardíaca máxima o la presión arterial. 
...
Para revisar si las variables estan normalizadas vamos a aplicar el test de Shapiro Wilk en cada variable numérica.
